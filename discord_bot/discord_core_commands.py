...
def register_core_commands(bot, agent_config):
    ...
    logger.info(f"Core commands registered: {greet_name}, {nogreet_name}, {welcome_name}, {nowelcome_name}, {insult_name}, agenthelp, canvas, {role_cmd_name}, test, readme, testpersonalityevolution")
