...
class RingDB:
    ...
    def save_config(self, enabled: bool, current_accusation: str = None, 
        ...
        try:
            # Get existing config
            existing_config = self.roles_db.get_role_config('ring', self.server_name)
            ...
            if accused_user is not None:
                data['accused_user'] = accused_user
            ...
            return self.roles_db.save_role_config('ring', self.server_name, enabled, json.dumps(data))
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        try:
            config = self.roles_db.get_role_config('ring', self.server_name)
            ...
            return {
                ...
                'accused_user': data.get('accused_user'),
            ...
            return {'enabled': True, 'current_accusation': None, 'accused_user': None, 'accused_at': None, 'config_data': '{}'}
    ...
    def save_accusation(self, accuser_id: str, accused_id: str, 
        ...
        return self.roles_db.save_ring_accusation(
            self.server_name, accuser_id, accused_id, accusation, evidence
        )
    
    def get_accusations(self, limit: int = 10) -> List[Dict[str, Any]]:
        """Get recent ring accusations for a server."""
        return self.roles_db.get_ring_accusations(self.server_name, limit)


# Global database instance
def get_ring_db_instance(server_name: str = "default") -> RingDB:
    """Get the ring database instance using centralized roles.db."""
    return RingDB(server_name)
