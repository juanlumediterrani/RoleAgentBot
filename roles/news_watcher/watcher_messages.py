...
def get_default_messages():
    ...
    return {
        ...
        "usage_subscribe": "📝 Usage: `!watcher subscribe <category> [feed_id]`",
        "usage_unsubscribe": "📝 Usage: `!watcher unsubscribe <category> [feed_id]`",
        "usage_general": "📝 Usage: `!watcher general <category>`",
        "usage_keywords": "📝 Usage: `!watcher keywords \"word1,word2,word3\"`",
        ...
        "usage_channel_subscribe": "📝 Usage: `!watcherchannel subscribe <category> [feed_id]`",
